---
title: 'BJUT-Helper'
description: '北京工业大学课程资源共享计划'
publishedAt: '2022-05-30'
techs: 'git,markdown'
banner: 'https://cdn.bjutswift.cn/https://raw.githubusercontent.com/bjut-swift/swift-image-hosting/main/swift-nest/projects/swift-logo.png'
tags: 'program'
link: 'https://helper.bjutswift.cn'
---

<br />
<div className='flex justify-center'>
  <GithubCard repo='bjut-swift/BJUT-Helper' />
</div>
...
提交的内容推荐为 PDF、 <LaTeX>\LaTeX</LaTeX> 、Markdown、docx(除非是试卷本身格式，否则建议用 Markdown 代替 Word)格式，本项目不收录任何学校老师的课件。
...
<NextImage
  src='https://cdn.bjutswift.cn/https://raw.githubusercontent.com/bjut-swift/swift-image-hosting/main/swift-nest/post/bjuthelp.jpg'
  alt='右侧示例图片'
  width={500}
  height={500}
...
再次重申，提交的内容推荐为 PDF、<LaTeX>\LaTeX</LaTeX> 、Markdown、docx(Word)格式，本项目不收录任何学校老师的课件。
...
<div className='relative my-4 w-full overflow-hidden rounded-lg bg-white/80 p-4 shadow-lg backdrop-blur-sm dark:bg-gray-800/80'>
  <div className='bg-noise absolute inset-0 opacity-20' />
  <div className='relative'>
    <a
      href='https://star-history.com/#bjut-swift/BJUT-Helper&Date'
      target='_blank'
    ...
    >
      ...
      >
        <foreignObject width='100%' height='100%'>
          <iframe
            src='https://api.star-history.com/svg?repos=bjut-swift/BJUT-Helper&type=Date'
            width='100%'
            height='100%'
            frameBorder='0'
            scrolling='no'
